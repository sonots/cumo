...
extern enum CBLAS_TRANSPOSE cumo_cublas_option_trans(VALUE trans);

#define option_uplo cumo_cublas_option_uplo
extern enum CBLAS_UPLO cumo_cublas_option_uplo(VALUE uplo);

#define option_diag cumo_cublas_option_diag
extern enum CBLAS_DIAG cumo_cublas_option_diag(VALUE diag);

#define option_side cumo_cublas_option_side
extern enum CBLAS_SIDE cumo_cublas_option_side(VALUE side);
