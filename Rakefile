...
task :docs do
  dir = "ext/cumo"
  src = %w[array.c data.c index.c math.c narray.c rand.c struct.c].map{|s| File.join(dir, "narray", s)} +
    [File.join(dir, "narray", "types/*.c"), File.join(dir, "cuda", "*.{c,cpp}"), "lib/cumo/narray/extra.rb"]
